...
// corn for checking loging status
cron.schedule("*/60 * * * * *", cronController.checkLoggedStatus);
// notification before 15 mins
cron.schedule("*/50 * * * * *", cronController.notificationBefore15);
// notification for cover job before 15 mins
cron.schedule("*/50 * * * * *", cronController.coverJobBefore15);
