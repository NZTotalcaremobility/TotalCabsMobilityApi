...
var cronController = require ('../controllers/cron')
...
router.post('/notificationMarkRead', notificationController.notificationMarkRead)

// -------------------------------------------------------------------------------------------------------------------------

router.post('/getReviewAndRating', drivercontroller.getReviewAndRating)
router.post('/deeplink', ridercontroller.deeplink)
router.post('/notificationBefore15', cronController.notificationBefore15)
...
router.post('/CompanyUserList', companycontroller.CompanyUserList)
...
router.post('/jobCancelled', drivercontroller.jobCancelled)
...
router.post('/adminAddCompanyUser', upload.any(), companycontroller.adminAddCompanyUser)
router.post('/adminGetCustomerByid', customercontroller.adminGetCustomerByid)
router.post('/adminGetJobByid', customercontroller.adminGetJobByid)
router.post('/adminGetCustomer', customercontroller.adminGetCustomer)
router.post('/adminUpdateCustomer', upload.any(), customercontroller.adminUpdateCustomer)
router.post('/UpdatecompanyCustomer', upload.any(), companycontroller.UpdatecompanyCustomer)
...
router.post('/getJobByid', drivercontroller.getJobByid)
...
router.post('/notifyMobile', jobcontroller.notifyMobile)
router.post('/adminAddDespatchJobs', jobcontroller.adminAddDespatchJobs)
router.post('/updateDispatchJob/edit/:_id', jobcontroller.updateDispatchJob)
...
router.post('/updatecoverJob/edit/:_id', jobcontroller.updatecoverJob)
router.post('/adminGetDispatchJob', jobcontroller.adminGetDispatchJob)
router.post('/getCoverJobByID/job/:_id', jobcontroller.getCoverJobByID)
router.post('/adminGetCoverJob', jobcontroller.adminGetCoverJob)
